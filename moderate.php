...
<div class="hol-page-screen">
  <div class="hol-page-panel">
    <h1 class="hol-page-heading" style="font-size:34px;margin-bottom:32px;">Moderation Dashboard</h1>

    <h2 class="hol-section-heading" style="margin-bottom:16px;">All Entries</h2>
    <div class="hol-rank-panel" style="margin-bottom:40px;">
      <?php while ($e = $entries->fetch_assoc()): ?>
        <div class="hol-leaderboard-row" style="align-items:center;">
          ...
          <div style="display:flex;gap:8px;">
            <a href="edit.php?id=<?php echo $e['entry_id']; ?>" class="hol-button-outline-red hol-button">Edit</a>
            <form method="POST" action="delete.php" data-confirm="Delete this entry?">
              ...
              <button type="submit" class="hol-button-outline-red hol-button">Delete</button>
            </form>
          </div>
        </div>
      <?php endwhile; ?>
    ...
    <h2 class="hol-section-heading" style="margin-bottom:16px;">All Users</h2>
      ...
      <?php while ($u = $users->fetch_assoc()): ?>
        <div class="hol-leaderboard-row">
          ...
          <form method="POST" action="promote.php">
            ...
            <button type="submit" class="hol-button-outline-red hol-button"><?php echo $u['role'] === 'admin' ? 'Revoke Admin' : 'Make Admin'; ?></button>
          </form>
        </div>
      <?php endwhile; ?>
    </div>
