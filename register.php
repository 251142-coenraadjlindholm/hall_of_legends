...
<div class="hol-screen">
  <div class="hol-panel hol-panel--narrow">
    ...
    <form method="POST" action="register.php">
      <div class="hol-field">
        <label class="hol-label" for="username">Username:<span class="hol-required">*</span></label>
        <input class="hol-input" type="text" id="username" name="username" required value="<?php echo htmlspecialchars($_POST['username'] ?? ''); ?>">
      </div>
      <div class="hol-field">
        <label class="hol-label" for="email">Email:<span class="hol-required">*</span></label>
        <input class="hol-input" type="email" id="email" name="email" required value="<?php echo htmlspecialchars($_POST['email'] ?? ''); ?>">
      </div>
      <div class="hol-field">
        <label class="hol-label" for="password">Password:<span class="hol-required">*</span></label>
        <input class="hol-input" type="password" id="password" name="password" required>
      </div>
      <div class="hol-field" style="margin-bottom:20px;">
        <label class="hol-label" for="confirm_password">Confirm Password:<span class="hol-required">*</span></label>
        <input class="hol-input" type="password" id="confirm_password" name="confirm_password" required>
      </div>
